 ...
 *
 * Except for this comment, the exp.h file is exactly the same as
 * is appears in Chapter 14.  The only change you need to make in
 * this file is to add methods to the EvalState class so that
 * clients can set and get the number of the next program line.
 */
